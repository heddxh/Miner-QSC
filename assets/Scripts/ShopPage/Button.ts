...
//前面是用户的道具数量，后者
let zdty: number = 0;
let num_zdty: number = 2; //浙大体艺
let shxj: number = 0;
let num_shxj: number = 2; //三花学姐
let wmg: number = 0;
let num_wmg: number = 2; //外卖柜
let qsc: number = 0;
let num_qsc: number = 2; //求是潮
let kyj: number = 0;
let num_kyj: number = 2; //烤鸭卷
...
export class ShopPage extends Component {
    ...
    start() {
        ...
        this.target1.on(
            ...
            (event) => {
                console.log("1 Touch");
                this.msg.getComponent(Label).string =
        ...
        this.target2.on(
            ...
            (event) => {
                console.log("2 Touch");
                this.msg.getComponent(Label).string =
                    "“在求是潮的buff之下 钻石double闪闪!” 在关卡中钻石将变得相当值钱。";
            },
            this
        );
        this.target3.on(
        ...
        this.target5.on(
            ...
            (event) => {
                console.log("5 Touch");
                this.msg.getComponent(Label).string =
                    "“你会打开哪个柜门？恭喜你，拥有交换价值的权利”石头将有三次机遇会变成相当有价值的物品。";
            },
            this
        );
